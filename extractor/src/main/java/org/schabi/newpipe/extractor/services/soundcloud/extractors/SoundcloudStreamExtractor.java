...
import org.schabi.newpipe.extractor.stream.HlsUtils;
...
public class SoundcloudStreamExtractor extends StreamExtractor {
    ...
    private StreamBuildResult buildBaseAudioStream(final JsonObject transcoding,
        ...
        ExtractorLogger.d(TAG, "Building base audio stream info");
        ...
        final var hlsPlaylistUrl = HlsUtils.getStreamContentUrl(getApiStreamUrl(url));
    ...
    private HlsAudioStream buildHlsAudioStream(final JsonObject transcoding)
            throws ExtractionException, IOException {
        ExtractorLogger.d(TAG, "Extracting hls audio stream");
        ...
        builder.setPlaylistId(HlsUtils.extractHlsPlaylistId(buildResult.contentUrl,
    ...
    private AudioStream buildProgressiveAudioStream(final JsonObject transcoding)
            throws ExtractionException, IOException {
        ExtractorLogger.d(TAG, "Extracting progressive audio stream");
                ...
                .forEachOrdered(transcoding -> {
                    ...
                    try {
                        ...
                        if (audioStream != null
                            ...
                            ExtractorLogger.d(TAG, "built audio stream "
                        ...
                        ExtractorLogger.e(TAG,
                                     "Failed to extract audio stream for transcoding "
                                          + '[' + protocol + '/' + preset + "] " + url,
                                          e);
                    }
                });
